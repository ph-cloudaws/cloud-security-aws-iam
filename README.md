...
**3. \*\*User Groups and Users\*\***  
   ...
   **!\[Step 3 - Users and Groups](images/part4.png)**
...
**4. \*\*Account Alias\*\***  
   ...
   **!\[Step 4 - Account Alias](images/part3.png)**



**5. \*\*Testing Permissions\*\***  

   **- Logged in as an IAM user and attempted to stop each EC2 instance:**  

     **- \*\*Production Instance:\*\* Access denied (correct behavior)**  

     **- \*\*Development Instance:\*\* Access allowed (correct behavior)**  

   **!\[Step 5 - Testing Permissions](images/part6.png)**
